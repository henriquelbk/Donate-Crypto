...
export default function Create(){
    ...
    return (
        <>
        <Head>
            <title>Donate Crypto | Create a Campaign</title>
            <meta charSet="utf-8" />
        ...
        <h1 className="display-5 fw-bold text-body-emphasis lh-1 mb-3">
          ...
          <div className="col-6">
            ...
            <div className="form-floating mb-3">
                <textarea type="description" id="title" className="form-control" value={campaign.description} onChange={onInputChange}/>
                <label for="description">Description:</label>
            </div>
            <div className="form-floating mb-3">
                <input type="description" id="imageUrl" className="form-control" value={campaign.imageUrl} onChange={onInputChange}/>
                <label for="imageUrl">Image Url:</label>
            </div>
            <div className="form-floating mb-3">
                <input type="description" id="videoUrl" className="form-control" value={campaign.videoUrl} onChange={onInputChange}/>
